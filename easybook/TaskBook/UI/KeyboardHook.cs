...
namespace MouseKeyboardLibrary
{
    ...
    public class KeyboardHook : GlobalHook
    {
        ...
        protected override int HookCallbackProcedure(int nCode, int wParam, IntPtr lParam)
        {
            ...
            if (nCode > -1 && (KeyDown != null || KeyUp != null || KeyPress != null))
            {
                ...
                KeyEventArgs e = new HookKeyEventArgs(
                    (Keys)(
    ...
    public class HookKeyEventArgs : KeyEventArgs
    {
        ...
        public HookKeyEventArgs(Keys keyData, int scanCode, bool extendKeyKey)
            : base(keyData)
        {
            _scanCode = scanCode;
            _isExtentedKey = extendKeyKey;
        }

        private bool _isExtentedKey;

        public bool IsExtendedKey
        {
            get { return _isExtentedKey; }
        }
